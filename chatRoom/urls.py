...
urlpatterns = [
    ...
    path('DiscussionLike/<str:dno>',views.DiscussionLikeView.as_view(),name='likeDiscussion'),
    path('atmessage', views.AtMessageView.as_view(), name='atMessage'),
    path('all/folder/<str:username>',views.FavoriteFolder.as_view(),name='allFolder'),
